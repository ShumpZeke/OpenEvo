...
Tests: `./test.sh` → 431 upstream + 456 control plane + 359 OE-MAX + 34
...
### 3.5d RLIMIT_NPROC counts the user, and a too-tight one fakes a passing test
...
```
branch     main
tests      431 upstream + 402 control plane + 359 OE-MAX + 34 BrainPort = 1280 passing
...
local      FULLY SUPPORTED. OE_MAX_LOCAL_ONLY=1 constructs only Ollama,
           ...
           0 failed, combined_score 1.4198. See LOCAL_MODE.md
